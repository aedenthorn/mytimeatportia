...
namespace Invasion
{
    public class Main
    {
        ...
        private static Monster GetRandomMonster(System.Random rand)
        {

            Monster[] Monsters = MonstersLow;
            int l337 = Get1337Level();
            switch (l337)
            {
                case 4:
        ...
        private static readonly Monster[] MonstersHigh = new Monster[]
        {
            ...
            //new Monster(290049, "All-Source AI"), //60
            new Monster(190045, "Piggy-bot 007"), //42
        ...
        private static readonly Monster[] MonstersElite = new Monster[]
        {
            ...
            new Monster(231047, "Piggy-bot 032"), //48
            new Monster(20028050, "Rat King"), //50
